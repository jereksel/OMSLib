...
public final class OverlayInfo implements Parcelable {
     ...
     * objects exposed outside the OverlayManagerService should never have this
     * state.
     */
    ...
    public OverlayInfo(String packageName, String targetPackageName,
                       String baseCodePath, int state, int userId) {
